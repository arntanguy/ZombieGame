...
public class Field {
	...
	public Object getObjectAt(Location location) {
		...
		Object obj = getObjectAt(location.getRow(), location.getCol());

		if (obj != null && !obj.getClass().getName().contains("character")) {
			System.out.println("getObjectAtLocation...");
			Class klass = obj.getClass();
			System.out.println("class = " + klass.getName());
			System.out.println("BaseObject? "
					+ (obj instanceof object.BaseObject));
			System.out
					.println("Vampire? " + (obj instanceof character.Vampire));
		}
	...
	public Object getObjectAt(int row, int col) {
		...
		if (obj != null && !obj.getClass().getName().contains("character")) {
			System.out.println("getObjectAtField...");
			Class klass = obj.getClass();
			System.out.println("class = " + klass.getName());
			System.out.println("BaseObject? "
					+ (obj instanceof object.BaseObject));
	...
	public List<Location> getFreeAdjacentLocations(Location location) {
		...
		for (Location next : adjacent) {
			if (getObjectAt(next) == null
					|| getObjectAt(next) instanceof BaseObject) {
				if ((getObjectAt(next) instanceof BaseObject))
					System.out
	 ...
	 * @return A valid location within the grid area.
	 */
	public Location ObjectAdjacentLocation(Location location) {
		// The available free ones.
		List<Location> free = getFreeAdjacentLocations(location);
